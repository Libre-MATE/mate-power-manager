...
#define GPM_PHONE_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), GPM_TYPE_PHONE, GpmPhoneClass))
...
#define GPM_PHONE_GET_CLASS(o) \
  (G_TYPE_INSTANCE_GET_CLASS((o), GPM_TYPE_PHONE, GpmPhoneClass))

...
#define GPM_SCREENSAVER(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), GPM_TYPE_SCREENSAVER, GpmScreensaver))
#define GPM_SCREENSAVER_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), GPM_TYPE_SCREENSAVER, GpmScreensaverClass))
#define GPM_IS_SCREENSAVER(o) \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), GPM_TYPE_SCREENSAVER))
#define GPM_IS_SCREENSAVER_CLASS(k) \
  (G_TYPE_CHECK_CLASS_TYPE((k), GPM_TYPE_SCREENSAVER))
#define GPM_SCREENSAVER_GET_CLASS(o) \
  (G_TYPE_INSTANCE_GET_CLASS((o), GPM_TYPE_SCREENSAVER, GpmScreensaverClass))

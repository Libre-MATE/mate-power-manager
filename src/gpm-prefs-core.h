...
#define GPM_PREFS_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), GPM_TYPE_PREFS, GpmPrefsClass))
...
#define GPM_PREFS_GET_CLASS(o) \
  (G_TYPE_INSTANCE_GET_CLASS((o), GPM_TYPE_PREFS, GpmPrefsClass))

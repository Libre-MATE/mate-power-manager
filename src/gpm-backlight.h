...
#define GPM_BACKLIGHT(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), GPM_TYPE_BACKLIGHT, GpmBacklight))
#define GPM_BACKLIGHT_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), GPM_TYPE_BACKLIGHT, GpmBacklightClass))
#define GPM_IS_BACKLIGHT(o) \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), GPM_TYPE_BACKLIGHT))
#define GPM_IS_BACKLIGHT_CLASS(k) \
  (G_TYPE_CHECK_CLASS_TYPE((k), GPM_TYPE_BACKLIGHT))
#define GPM_BACKLIGHT_GET_CLASS(o) \
  (G_TYPE_INSTANCE_GET_CLASS((o), GPM_TYPE_BACKLIGHT, GpmBacklightClass))
...
gboolean gpm_backlight_set_brightness(GpmBacklight *backlight, guint brightness,
                                      GError **error);

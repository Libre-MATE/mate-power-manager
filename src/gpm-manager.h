...
#define GPM_MANAGER(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), GPM_TYPE_MANAGER, GpmManager))
#define GPM_MANAGER_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), GPM_TYPE_MANAGER, GpmManagerClass))
...
#define GPM_MANAGER_GET_CLASS(o) \
  (G_TYPE_INSTANCE_GET_CLASS((o), GPM_TYPE_MANAGER, GpmManagerClass))
...
gboolean gpm_manager_can_suspend(GpmManager *manager, gboolean *can_suspend,
                                 GError **error);
gboolean gpm_manager_can_hibernate(GpmManager *manager, gboolean *can_hibernate,
                                   GError **error);

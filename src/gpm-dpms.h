...
#define GPM_DPMS_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), GPM_TYPE_DPMS, GpmDpmsClass))
...
#define GPM_DPMS_GET_CLASS(o) \
  (G_TYPE_INSTANCE_GET_CLASS((o), GPM_TYPE_DPMS, GpmDpmsClass))
...
typedef enum { GPM_DPMS_ERROR_GENERAL } GpmDpmsError;

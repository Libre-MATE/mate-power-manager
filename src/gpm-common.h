...
#define GPM_SETTINGS_KBD_BRIGHTNESS_DIM_BY_ON_BATT \
  "kbd-brightness-dim-by-on-battery"
#define GPM_SETTINGS_KBD_BRIGHTNESS_DIM_BY_ON_IDLE \
  "kbd-brightness-dim-by-on-idle"
...
gboolean gpm_notebook_scroll_event_cb(GtkWidget *widget, GdkEventScroll *event);
#ifdef EGG_TEST

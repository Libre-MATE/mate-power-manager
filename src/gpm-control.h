...
#define GPM_CONTROL(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), GPM_TYPE_CONTROL, GpmControl))
#define GPM_CONTROL_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), GPM_TYPE_CONTROL, GpmControlClass))
...
#define GPM_CONTROL_GET_CLASS(o) \
  (G_TYPE_INSTANCE_GET_CLASS((o), GPM_TYPE_CONTROL, GpmControlClass))

...
#define MSD_MEDIA_KEYS_WINDOW(obj)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), MSD_TYPE_MEDIA_KEYS_WINDOW, \
                              MsdMediaKeysWindow))
#define MSD_MEDIA_KEYS_WINDOW_CLASS(klass)                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), MSD_TYPE_MEDIA_KEYS_WINDOW, \
                           MsdMediaKeysWindowClass))
#define MSD_IS_MEDIA_KEYS_WINDOW(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), MSD_TYPE_MEDIA_KEYS_WINDOW))
#define MSD_IS_MEDIA_KEYS_WINDOW_CLASS(klass) \
  (G_TYPE_INSTANCE_GET_CLASS((klass), MSD_TYPE_MEDIA_KEYS_WINDOW))

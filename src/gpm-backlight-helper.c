 ...
 **/
static gchar *gcm_backlight_helper_get_best_backlight(void) {
  gchar *filename;
  guint i;
  gboolean ret;
  GDir *dir = NULL;
 ...
 **/
static gboolean gcm_backlight_helper_write(const gchar *filename, gint value,
                                           GError **error) {
  gchar *text = NULL;
  gint retval;
  gint length;
...
gint main(gint argc, gchar *argv[]) {
  ...
  g_option_context_set_summary(context,
                               _("MATE Power Manager Backlight Helper"));

...
#define GPM_KBD_BACKLIGHT(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), GPM_TYPE_KBD_BACKLIGHT, GpmKbdBacklight))
#define GPM_KBD_BACKLIGHT_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), GPM_TYPE_KBD_BACKLIGHT, GpmKbdBacklightClass))
#define GPM_IS_KBD_BACKLIGHT(o) \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), GPM_TYPE_KBD_BACKLIGHT))
#define GPM_IS_KBD_BACKLIGHT_CLASS(k) \
  (G_TYPE_CHECK_CLASS_TYPE((k), GPM_TYPE_KBD_BACKLIGHT))
#define GPM_KBD_BACKLIGHT_GET_CLASS(o) \
  (G_TYPE_INSTANCE_GET_CLASS((o), GPM_TYPE_KBD_BACKLIGHT, GpmKbdBacklightClass))
...
typedef struct {
  ...
  void (*brightness_changed)(GpmKbdBacklight *backlight, gint brightness);

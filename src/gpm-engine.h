...
#define GPM_ENGINE(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), GPM_TYPE_ENGINE, GpmEngine))
#define GPM_ENGINE_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), GPM_TYPE_ENGINE, GpmEngineClass))
...
#define GPM_ENGINE_GET_CLASS(o) \
  (G_TYPE_INSTANCE_GET_CLASS((o), GPM_TYPE_ENGINE, GpmEngineClass))

...
#define GPM_SESSION(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), GPM_TYPE_SESSION, GpmSession))
#define GPM_SESSION_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), GPM_TYPE_SESSION, GpmSessionClass))
...
#define GPM_SESSION_GET_CLASS(o) \
  (G_TYPE_INSTANCE_GET_CLASS((o), GPM_TYPE_SESSION, GpmSessionClass))
...
typedef struct {
  ...
  void (*inhibited_changed)(GpmSession *session, gboolean is_idle_inhibited,

...
#define GPM_IDLE_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), GPM_TYPE_IDLE, GpmIdleClass))
...
#define GPM_IDLE_GET_CLASS(o) \
  (G_TYPE_INSTANCE_GET_CLASS((o), GPM_TYPE_IDLE, GpmIdleClass))

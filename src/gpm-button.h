...
#define GPM_BUTTON(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), GPM_TYPE_BUTTON, GpmButton))
#define GPM_BUTTON_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), GPM_TYPE_BUTTON, GpmButtonClass))
...
#define GPM_BUTTON_GET_CLASS(o) \
  (G_TYPE_INSTANCE_GET_CLASS((o), GPM_TYPE_BUTTON, GpmButtonClass))
